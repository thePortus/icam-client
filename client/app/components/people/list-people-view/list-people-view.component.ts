 ...
 */
@Component({
  selector: 'app-list-people-view',
  templateUrl: './list-people-view.component.html',
  styleUrls: ['./list-people-view.component.scss']
})
export class ListPeopleViewComponent implements OnInit {
