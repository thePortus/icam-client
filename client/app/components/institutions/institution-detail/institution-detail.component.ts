...
export class InstitutionDetailComponent implements OnInit {
  ...
  deleteItem() {
    ...
    const dialogRef = this.dialog.open(ConfirmDeleteInstitutionDialog, {
      width: '250px',
      data: {id: this.institutionId, title: this.protectedData.title},
    });
...
@Component({
  selector: 'confirm-delete-institution-dialog',
  templateUrl: 'confirm-delete-institution.dialogue.html',
})
export class ConfirmDeleteInstitutionDialog {

  constructor(
    public dialogRef: MatDialogRef<ConfirmDeleteInstitutionDialog>,
