 ...
 */
@Component({
  selector: 'app-list-locations-view',
  templateUrl: './list-locations-view.component.html',
  styleUrls: ['./list-locations-view.component.scss']
})
export class ListLocationsViewComponent implements OnInit {
